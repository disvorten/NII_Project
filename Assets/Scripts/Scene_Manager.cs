...
public class Scene_Manager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        forward_url.text = PlayerPrefs.GetString("forward_url", "http://10.8.0.4:8889/stream1/whep");
        back_url.text = PlayerPrefs.GetString("back_url", "http://10.8.0.4:8889/stream2/whep");
